...
// AddReaders updates the packing for the other readers as specified by the Access file.
...
func AddReaders(cfg upspin.Config, op string, entry *upspin.DirEntry, packer upspin.Packer, readers []upspin.UserName) error {
...
func Lookup(c upspin.Client, op string, entry *upspin.DirEntry, fn LookupFn, followFinal bool, s *metric.Span) (resultEntry, finalSuccessfulEntry *upspin.DirEntry, err error) {
